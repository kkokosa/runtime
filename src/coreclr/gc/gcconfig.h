...
#define GC_CONFIGURATION_KEYS \
    ...
    BOOL_CONFIG  (GCDynamicAdaptationBudgetAtHeapLimit, "GCDynamicAdaptationBudgetAtHeapLimit", NULL,                            false,              "Use DATAS budget growth at the runtime heap-count limit (DOTNET_GCDynamicAdaptationBudgetAtHeapLimit=1).") \
