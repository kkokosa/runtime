...
// pfnHelper is set to NULL if it is an unused helper.
    ...
    DYNAMICJITHELPER(CORINFO_HELP_BULK_WRITEBARRIER_WITH_LAYOUT, NULL, METHOD__BUFFER__MEMCOPYGC_WITH_LAYOUT)
    DYNAMICJITHELPER(CORINFO_HELP_BULK_WRITEBARRIER_CLEAR_WITH_LAYOUT, NULL, METHOD__BUFFER__MEMCLEARGC_WITH_LAYOUT)
