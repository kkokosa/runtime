...
public:
    ...
    FCDECL6(static VOID, BulkMoveValueClassWithOldValueWriteBarrier, void* dst, void* src, MethodTable* type, size_t elementSize, size_t chunkOffset, size_t chunkSize);
    ...
    FCDECL5(static VOID, ClearValueClassWithOldValueWriteBarrier, void* dst, MethodTable* type, size_t elementSize, size_t chunkOffset, size_t chunkSize);
};
